...
def creat_struct_pdf(Sexe,nb_mere,nb_foetus,nb_pere,date,nom,Concordance_mf, Concordance_pf,Contamination,choix_utilisateur):#selon concord et si oui petit détail pr manuel ou auto
    ...
    if Concordance_mf=="OUI": 
        if Concordance_pf=="OUI":
            ...
            data = [ ["Marqueurs","Contamination materno-fœtale","","","","Concordances des ADN paternelles et fœtals","",""],
                     ["","Informativités","Résultats","Pourcentages de contamination","Détails M/F","Concordances Père/Fœtus","Détails allèles père","Détails allèles fœtus"],
                     ["CSF1PO","","","","","","",""],
                     ["D13S317","","","","","","",""],
                     ["D16S539","","","","","","",""],
                     ["D18S51","","","","","","",""],
        ...
        if Concordance_pf=="OUI":
           data = [ ["Marqueurs","Concordances des \nADN maternelles et fœtal","Détails allèle mère","Détails allèle fœtus"],
                     ["CSF1PO","","",""],
                     ["D13S317","","",""],
                     ["D16S539","","",""],
                     ["D18S51","","",""],
             ...
             data = [ ["Marqueurs","Concordances des\n ADN maternelles et fœtals","Détails allèles mère","Détails allèles fœtus","Concordances des \nADN paternelles et fœtals","Détails allèles père","Détails allèles fœtus"],
                     ["CSF1PO","","","","","",""],
                     ["D13S317","","","","","",""],
                     ["D16S539","","","","","",""],
                     ["D18S51","","","","","",""],
...
def creation_PDF(nom_projet, nom_fichier_mere, nom_fichier_foetus, nom_fichier_pere, Sexe, dataframe, det_dataframe, choix_utilisateur):
    ...
    C,Conclusion,CHU,LOGO,canv = init_pdf(Concordance_mf, Concordance_pf,Contamination,path,nb_info_Nconta,nb_info_Conta,moy_conta)
    HEADER,t_entete,data = creat_struct_pdf(Sexe,nb_mere,nb_foetus,nb_pere,date,nom,Concordance_mf, Concordance_pf,Contamination,choix_utilisateur)
...
if __name__ == "__main__":
    ...
    path=""
    choix_utilisateur=1
    creation_PDF(nom_projet, nom_fichier_mere, nom_fichier_foetus, nom_fichier_pere, Sexe, dataframe, det_dataframe, choix_utilisateur)
